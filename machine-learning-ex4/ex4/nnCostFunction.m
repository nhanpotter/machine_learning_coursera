...
for i=1:m
  ...
  z3 = Theta2*a2;
  a3 = sigmoid(z3);
  y_train = [1:num_labels] == y(i);
  y_train = y_train(:);
  %Part 1
  J = J +(1/m)*sum(-y_train.*log(a3)-(1-y_train).*log(1-a3));
  
  %Part 2
  dif3 = a3-y_train;
  Theta2_grad = Theta2_grad + dif3*a2';
  dif2 = (Theta2'*dif3)(2:end).* sigmoidGradient(z2);
  Theta1_grad = Theta1_grad + dif2*a1';
